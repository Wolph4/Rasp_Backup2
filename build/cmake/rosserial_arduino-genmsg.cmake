...
message(STATUS "rosserial_arduino: 2 messages, 0 services")

set(MSG_I_FLAGS "-Irosserial_arduino:/home/test/catkin_ws/src/ /msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/test/catkin_ws/src/ /msg/my.msg" NAME_WE)
add_custom_target(_rosserial_arduino_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosserial_arduino" "/home/test/catkin_ws/src/ /msg/my.msg" ""
)

get_filename_component(_filename "/home/test/catkin_ws/src/ /msg/now_moter.msg" NAME_WE)
add_custom_target(_rosserial_arduino_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosserial_arduino" "/home/test/catkin_ws/src/ /msg/now_moter.msg" ""
)
